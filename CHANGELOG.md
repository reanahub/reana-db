...
## [0.9.6](https://github.com/reanahub/reana-db/compare/0.9.5...0.9.6) (2026-09-16)


### ⚠ BREAKING CHANGES

* **models:** Remove UserToken and the legacy access-token helpers. Database upgrades permanently delete legacy REANA access tokens. Deploy the OIDC-compatible REANA components together and configure REANA_SECRET_KEY explicitly. Returning to the legacy token schema requires restoring a database backup.
...
* **models:** link OIDC identities and protect scoped secrets ([#269](https://github.com/reanahub/reana-db/issues/269)) ([60010b7](https://github.com/reanahub/reana-db/commit/60010b7182bf3ecb401c44479e5019595808722d))
* **models:** support caller-owned retention transactions ([#270](https://github.com/reanahub/reana-db/issues/270)) ([d98c0a9](https://github.com/reanahub/reana-db/commit/d98c0a9178a3fa74c04f8e9d662680ccf0bbaa60))
